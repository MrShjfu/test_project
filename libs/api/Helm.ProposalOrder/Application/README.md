...
Application services for the ProposalOrder module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.ProposalOrder.Contracts` interfaces (batch-first,

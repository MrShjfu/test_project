...
Application services for the Design module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.Design.Contracts` interfaces (batch-first,

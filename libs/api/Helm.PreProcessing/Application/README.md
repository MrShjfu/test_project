...
Application services for the PreProcessing module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.PreProcessing.Contracts` interfaces (batch-first,

...
Application services for the Planning module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.Planning.Contracts` interfaces (batch-first,

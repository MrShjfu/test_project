...
Application services for the Inventory module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.Inventory.Contracts` interfaces (batch-first,

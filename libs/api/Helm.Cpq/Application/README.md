...
Application services for the Cpq module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.Cpq.Contracts` interfaces (batch-first,

...
Application services for the AfterSales module: they orchestrate this module's domain, expose
synchronous reads to other modules via the `Helm.AfterSales.Contracts` interfaces (batch-first,
